...
// Stock items
const stock = [
  { name: 'AN-6 straight swivel hose end', category_id: catId('Plumbing & Fittings'), location_id: binA1_1, quantity: 14, unit: 'ea', low_stock_threshold: 5, manufacturer: 'Fragola', part_number: '496106-BL', supplier: 'Summit Racing', attrs_text: 'Thread: 9/16-18\nAngle: straight' },
  { name: 'AN-6 90° swivel hose end', category_id: catId('Plumbing & Fittings'), location_id: binA1_1, quantity: 3, unit: 'ea', low_stock_threshold: 4, manufacturer: 'Fragola', part_number: '496206-BL', supplier: 'Summit Racing' },
  ...
  { name: 'Deutsch DT 2-pin receptacle', category_id: catId('Wiring / Harness'), location_id: drawerDT, quantity: 42, unit: 'ea', low_stock_threshold: 15, manufacturer: 'TE / Deutsch', part_number: 'DT04-2P', supplier: 'Mouser', supplier_url: 'https://www.mouser.com/ProductDetail/DT04-2P', attrs_text: 'Series: DT\nPins: 2' },
  { name: 'Deutsch DT 2-pin plug', category_id: catId('Wiring / Harness'), location_id: drawerDT, quantity: 11, unit: 'ea', low_stock_threshold: 15, manufacturer: 'TE / Deutsch', part_number: 'DT06-2S', supplier: 'Mouser', attrs_text: 'Series: DT\nPins: 2' },
